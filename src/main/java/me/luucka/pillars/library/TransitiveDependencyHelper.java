	...
	public Collection<Library> findTransitiveLibraries(final Library library) {
		...
		try {
			...
			if (throwable instanceof SocketTimeoutException) {
				PillarLog.info("Failed to resolve transitive dependencies for " + library.getArtifactId() + " due to a timeout. This is a fatal issue and the plugin wont start due to missing library. "
				...
				throw new RuntimeException("Failed to resolve transitive dependencies for " + library.getArtifactId(), cause);
